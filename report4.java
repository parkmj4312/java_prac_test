...
class report4 {
    public static void main(String[] args) {
        ...
        //int[] arr[];
        //int[] arr = {1,2,3,}; //3 다음에 쉼표가 오고 배열을 닫았기 때문에 에러 발생
        //int[] arr = new int[5];
        //int[] arr = new int[5]{1,2,3,4,5};//new int[5]까지는 맞는데 후행에 {1,2,3,4,5}을 붙여서 에러
        //int arr[5];//선언애서 초기화 값을 넣어서 에러
        //int[] arr[] = new int[3][];
