...
class student{
    ...
    String info(){
        return name +", "+ban+", "+no+", "+kor+", "+eng+", "+math+" ,"+(kor+eng+math)+", "+String.format("%.1f",(float)(kor+eng+math)/3);
    }
...
class Exercise6_3 {
    public static void main(String args[]) {
        ...
        System.out.print("총점 : "+s.getTotal()+", ");
...
class student2{
    ...
    String getAverage(){
        return String.format("%.1f",(float)(kor + eng + math)/3);
    }
}
...
//각 마린 개체의 체력과 위치는 달라야 하지만 공격력과 방어력은 같아야 하기 때문에 weapon과 armor가 static 이어야 한다.